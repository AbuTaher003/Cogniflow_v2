      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 border-t border-white/5 pt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between text-[11px] text-slate-500">
          ...
          <div className="flex gap-5">
            <a href="#" className="hover:text-slate-300 transition uppercase tracking-wider">Twitter</a>
            <a href="#" className="hover:text-slate-300 transition uppercase tracking-wider">GitHub</a>
            <a href="#" className="hover:text-slate-300 transition uppercase tracking-wider">Discord</a>
          </div>
        </div>
      </div>
    </footer>
